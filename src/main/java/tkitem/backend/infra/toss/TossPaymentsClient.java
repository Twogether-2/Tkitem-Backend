package tkitem.backend.infra.toss;
...
public class TossPaymentsClient {
    ...
    private static final String CANCEL_PATH  = "/payments/{paymentKey}/cancel";
     ...
     * @return
     */
    public TossPaymentsResponse cancel(String paymentKey, String cancelReason) {
        return webClient.post()
