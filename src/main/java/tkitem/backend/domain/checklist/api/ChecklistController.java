...
public class ChecklistController {
    ...
    public ResponseEntity<ChecklistAiResponseDto> generateAiChecklist(@PathVariable Long tripId) {
        return ResponseEntity.ok(checklistService.generateAiChecklist(tripId));
    }
