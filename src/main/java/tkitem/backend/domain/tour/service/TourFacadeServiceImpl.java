...
public class TourFacadeServiceImpl implements TourFacadeService {
    ...
    public List<TourRecommendationResponseDto> recommend(TourRecommendationRequestDto req, String queryText, int topN) throws Exception {
        ...
        List<TourRecommendationResponseDto> base = tourRecommendService.recommendDbOnly(req, Math.max(DB_STAGE_TOP, topN));
        ...
        return tourRecommendService.enrichRecommendationDetails(base.subList(0, Math.min(topN, base.size())));
    }
}
